    ...
    <>
      <div className={styles.container}>
        ...
        <aside className={styles.cartTotalPrice}>
          ...
          <NavLink
            to="/orders"
            onClick={() => dispatch(purchase({ carts, orders }))}
              ...
              <div className={styles.productDetailContainer}>
                ...
                <div className={styles.minusplus}>
                  <button
                    onClick={() =>
                      dispatch(
                        decreaseItemToCart({ id: item.id, user: currentUser })
                      )
                    }
                  >
                  ...
                  <button
                    onClick={() =>
                      dispatch(
                        increaseItemToCart({ id: item.id, user: currentUser })
                      )
                    }
                  >
                ...
                <button
                  onClick={() =>
                    dispatch(
                      deleteItemFromCart({ id: item.id, user: currentUser })
                    )
                  }
